package com.cyberveda.client.api.main
...
import com.cyberveda.client.api.main.responses.BlogListSearchResponse
...
//        @Header("Authorization") authorization: String,
    ...
    fun createFeedback(
        ...
        @Part("body") body: RequestBody,
        @Part image: MultipartBody.Part?
    ): LiveData<GenericApiResponse<FeedbackCreateUpdateResponse>>


    @GET("feedback/list")
    fun searchListFeedbackPosts(
//        @Header("Authorization") authorization: String,
        @Query("search") query: String,
        @Query("ordering") ordering: String,
        @Query("page") page: Int
    ): LiveData<GenericApiResponse<FeedbackListSearchResponse>>


    @GET("feedback/{slug}/is_author")
