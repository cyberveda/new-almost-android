...
import com.cyberveda.client.persistence.BlogQueryUtils.Companion.ORDER_BY_ASC_DATE_UPDATED
import com.cyberveda.client.persistence.BlogQueryUtils.Companion.ORDER_BY_ASC_USERNAME
import com.cyberveda.client.persistence.BlogQueryUtils.Companion.ORDER_BY_DESC_DATE_UPDATED
import com.cyberveda.client.persistence.BlogQueryUtils.Companion.ORDER_BY_DESC_USERNAME

class BlogQueryUtils {


    companion object{
        private val TAG = "lgx_BlogQueryUtils"
        // values
