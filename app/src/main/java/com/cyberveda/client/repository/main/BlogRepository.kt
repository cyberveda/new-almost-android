...
import com.cyberveda.client.persistence.returnOrderedBlogQuery
...
import com.cyberveda.client.util.SuccessHandling.Companion.SUCCESS_BLOG_DELETED
...
constructor(
    ...
    private val TAG = "lgx_BlogRepository"
    fun searchBlogPosts(
//        authToken: AuthToken,
        query: String,
