package com.cyberveda.client.repository
...
import com.cyberveda.client.util.*
import com.cyberveda.client.util.Constants.Companion.NETWORK_TIMEOUT
import com.cyberveda.client.util.Constants.Companion.TESTING_CACHE_DELAY
import com.cyberveda.client.util.Constants.Companion.TESTING_NETWORK_DELAY
import com.cyberveda.client.util.ErrorHandling.Companion.ERROR_CHECK_NETWORK_CONNECTION
...
abstract class NetworkBoundResource<ResponseObject, CacheObject, ViewStateType>
    ...
    private val TAG = "lgx_NetworkBoundResource"
    ...
    suspend fun handleNetworkCall(response: GenericApiResponse<ResponseObject>){
        ...
        when(response){
            ...
            is ApiErrorResponse ->{
                ...
                onErrorReturn(response.errorMessage + "cool!", true, false)
            }
            is ApiEmptyResponse ->{
