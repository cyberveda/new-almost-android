package com.cyberveda.client.repository.auth

import android.content.SharedPreferences
import android.util.Log
import androidx.lifecycle.LiveData
import com.cyberveda.client.api.auth.OpenApiAuthService
import com.cyberveda.client.api.auth.network_responses.LoginResponse
import com.cyberveda.client.api.auth.network_responses.RegistrationResponse
...
import com.cyberveda.client.persistence.AuthTokenDao
...
import com.cyberveda.client.ui.auth.state.AuthViewState
import com.cyberveda.client.ui.auth.state.LoginFields
import com.cyberveda.client.ui.auth.state.RegistrationFields
import com.cyberveda.client.util.AbsentLiveData
import com.cyberveda.client.util.ApiSuccessResponse
import com.cyberveda.client.util.ErrorHandling.Companion.ERROR_SAVE_ACCOUNT_PROPERTIES
import com.cyberveda.client.util.ErrorHandling.Companion.ERROR_SAVE_AUTH_TOKEN
import com.cyberveda.client.util.ErrorHandling.Companion.GENERIC_AUTH_ERROR
import com.cyberveda.client.util.GenericApiResponse
import com.cyberveda.client.util.PreferenceKeys
import com.cyberveda.client.util.SuccessHandling.Companion.RESPONSE_CHECK_PREVIOUS_AUTH_USER_DONE
...
): JobManager("AuthRepository")
{
    ...
    private val TAG = "lgx_AuthRepository"
        ...
        return object: NetworkBoundResource<LoginResponse, Any, AuthViewState>(
            ...
            override suspend fun handleApiSuccessResponse(response: ApiSuccessResponse<LoginResponse>) {
                ...
                onCompleteJob(
                    DataState.data(
                        data = AuthViewState(
                            authToken = AuthToken(response.body.pk, response.body.token, response.body.email)
                        )
                    )
                )
            }
