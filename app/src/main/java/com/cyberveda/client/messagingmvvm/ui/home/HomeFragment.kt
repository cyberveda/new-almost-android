package com.cyberveda.client.messagingmvvm.ui.home
...
import com.cyberveda.client.databinding.HomeFragmentBinding
...
import com.cyberveda.client.messagingmvvm.model.ChatParticipant
import com.cyberveda.client.messagingmvvm.model.User
import com.cyberveda.client.messagingmvvm.service.MyFirebaseMessagingService
...
class HomeFragment : Fragment() {
    ...
    private val adapter: ChatPreviewAdapter by lazy {
        ChatPreviewAdapter(ClickListener { chatParticipant ->
            ...
            if (chatParticipant.particpant != null) {
...
//        (activity as AppCompatActivity).supportActionBar?.title = "Home FFFFFF"
//        activity?.title =
//            "Home"
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        //get user data
        homeViewModel.loggedUserMutableLiveData.observe(this, Observer { loggedUser ->
            ...
            homeViewModel.getChats(loggedUser!!)?.observe(this, Observer { chatParticipantsList ->
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        inflater.inflate(R.menu.main_menu_messaging, menu)
