package com.cyberveda.client.messagingmvvm.ui.chat
...
import com.cyberveda.client.databinding.ChatFragmentBinding
...
import com.cyberveda.client.messagingmvvm.Utils.eventbus_events.PermissionEvent
import com.cyberveda.client.messagingmvvm.Utils.eventbus_events.UpdateRecycleItemEvent
import com.cyberveda.client.messagingmvvm.model.*
...
class ChatFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (clickedUser.uid != null) {
            ...
            viewModel =
                ViewModelProvider(this, viewModeldFactory).get(ChatViewModel::class.java)
        }
    ...
    private fun sendMessage() {
        if (binding.messageEditText.text.isEmpty()) {
            Toast.makeText(context, getString(R.string.empty_message_messaging), Toast.LENGTH_LONG).show()
            return
        }
        viewModel.sendMessage(
            TextMessage(
