...
class DifferentUserProfileFragmentViewModel(val app: Application) : AndroidViewModel(app) {
    ...
    fun downloadProfilePicture(profilePictureUrl: String?) {
        ...
        val load: RequestBuilder<Drawable> =
            Glide.with(app).load(profilePictureUrl).placeholder(R.drawable.anonymous_profile).error(R.drawable.anonymous_profile)
                ...
                db.collection("users").document(it)
                    .addSnapshotListener { documentSnapshot, firebaseFirestoreException ->
                        ...
                        if (firebaseFirestoreException == null) {
                            val user =
                                documentSnapshot?.toObject(com.cyberveda.client.messagingmvvm.model.User::class.java)
