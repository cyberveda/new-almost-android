package com.cyberveda.client.ui.main.blog
...
import com.cyberveda.client.persistence.BlogQueryUtils.Companion.BLOG_FILTER_DATE_UPDATED
import com.cyberveda.client.persistence.BlogQueryUtils.Companion.BLOG_FILTER_USERNAME
import com.cyberveda.client.persistence.BlogQueryUtils.Companion.BLOG_ORDER_ASC
import com.cyberveda.client.persistence.BlogQueryUtils.Companion.BLOG_ORDER_DESC
import com.cyberveda.client.ui.DataState
import com.cyberveda.client.ui.main.blog.state.BlogViewState
import com.cyberveda.client.ui.main.blog.viewmodel.*
    ...
    SwipeRefreshLayout.OnRefreshListener
{
    ...
    private fun initRecyclerView(){
        ...
        blog_post_recyclerview.apply {
            layoutManager = LinearLayoutManager(this@BlogFragment.context) as RecyclerView.LayoutManager?
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when(item.itemId){
            ...
            R.id.action_account -> {
                findNavController().navigate(R.id.action_blogFragment_to_accountFragment)
            }
        }
