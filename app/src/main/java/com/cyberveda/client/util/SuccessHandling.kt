...
class SuccessHandling {
    ...
    companion object{
        ...
        const val RESPONSE_MUST_BECOME_CYBERVEDA_MEMBER = "You must become a member on Cyberveda.com to access the API. Visit https://cyberveda.com/enroll/"
        ...
        const val SUCCESS_FEEDBACK_CREATED = "created"
        const val SUCCESS_FEEDBACK_DELETED = "deleted"
